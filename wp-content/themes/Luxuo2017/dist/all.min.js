...
function handle_article_slider(){jQuery(".gallery");jQuery(".gallery br").remove(),jQuery('<div id="info"></div>').appendTo(".owl-controls"),jQuery(".gallery").owlCarousel({nav:!0,autoplay:!0,autoplayTimeout:3e3,pagination:!1,items:1,navSpeed:1e3,fluidSpeed:1e3,smartSpeed:1e3,loop:!0,dots:!0,navText:["<i class='fa fa-angle-left'></i>","<i class='fa fa-angle-right'></i>"]})}function clever_infinite_scroll(){jQuery("#article-post-content").cleverInfiniteScroll({contentsWrapperSelector:"#article-post-content",contentSelector:".content-wrapper",nextSelector:"#next-article",loadImage:"ajax-loader.gif",offset:jQuery(window).height()})}function make_edi_pick_fixed_non_infinite(){var e=jQuery(".sidebar-newsletter-container");if(e.length>0){var t=e.offset().top+e.outerHeight(!0),o=jQuery(document).height(),r=void 0!==window.outerHeight?jQuery(window).outerHeight(!0):jQuery(window).height(),i=jQuery(window).scrollTop(),a=t,n=jQuery(".sidebar-editors-picks"),s=(n.outerWidth(!0),e.outerWidth(!0));n.css({width:s+"px"});var u=n.outerHeight(!0),c=jQuery(".recommened-wrapper").outerHeight(!0),l=jQuery("footer").outerHeight(!0),d=jQuery("#article-post-content ").outerHeight(!0),p=jQuery(".sidebar-container").outerHeight(!0);if(u<=r){var y=r-u+10;n.css({top:y/2+"px"})}else n.css({top:""});i>=a&&d>=p?r+i+100>=o-l-c?n.removeClass("make-editors-pick-fixed"):(n.removeClass("make-editors-pick-fixed"),n.addClass("make-editors-pick-fixed")):n.removeClass("make-editors-pick-fixed")}}function make_edi_pick_fixed(){if(jQuery(".lx_fixed_sidebar .sidebar-newsletter-container").length>0){var e=jQuery(".sidebar-newsletter-container"),t=e.offset().top+e.outerHeight(!0),o=jQuery(document).height(),r=void 0!==window.outerHeight?jQuery(window).outerHeight(!0):jQuery(window).height(),i=jQuery(window).scrollTop(),a=t,n=jQuery(".sidebar-editors-picks"),s=(n.outerWidth(!0),e.outerWidth(!0));n.css({width:s+"px"});var u=n.outerHeight(!0),c=jQuery(".recommened-wrapper").outerHeight(!0),l=jQuery("footer").outerHeight(!0),d=jQuery("#article-post-content .lx_fixed_sidebar .left-side").outerHeight(!0),p=jQuery(".lx_fixed_sidebar .left-side.sidebar-container").outerHeight(!0);if(u<=r){var y=r-u;n.css({top:y/2+"px"})}else n.css({top:""});i>=a&&d>=p?r+i+100>=o-l-c?n.removeClass("make-editors-pick-fixed"):(n.removeClass("make-editors-pick-fixed"),n.addClass("make-editors-pick-fixed")):n.removeClass("make-editors-pick-fixed")}}function make_editors_pick_fixed(){if(jQuery(".sidebar-newsletter-container").length>0){var e=jQuery(".content-wrapper.active .sidebar-newsletter-container"),t=e.offset().top+e.outerHeight(!0),o=(jQuery(document).height(),void 0!==window.outerHeight?jQuery(window).outerHeight(!0):jQuery(window).height(),jQuery(window).scrollTop(),jQuery(".content-wrapper.active .sidebar-editors-picks")),r=(o.outerWidth(!0),e.outerWidth(!0));o.css({width:r+"px"});o.outerHeight(!0),jQuery(".recommened-wrapper").outerHeight(!0),jQuery("footer").outerHeight(!0),jQuery("#article-post-content .content-wrapper.active").outerHeight(!0),jQuery(".content-wrapper.active.sidebar-container").outerHeight(!0);return o.removeClass("make-editors-pick-fixed"),t}return 0}function back_to_top(){jQuery("body").on("click","#back_to_top",function(){jQuery("body,html").animate({scrollTop:0},700)})}function show_back_to_top(){var e=jQuery("#back_to_top");jQuery(this).scrollTop()>200?e.fadeIn():e.fadeOut()}function make_menu_sticky(){var e=jQuery("#menu_outer_wrapper"),t=e.height(),o=0+t;jQuery(this).scrollTop()>o?e.addClass("make_menu_sticky"):e.removeClass("make_menu_sticky")}jQuery(document).ready(function(){function e(e){var t=e.page.size;if(t>1)var o=e.item.index,r=o+t,i=o+1+"-"+r;else var i=e.item.index+1;jQuery("#info").text(i+"/"+e.item.count)}function t(){var e=jQuery(this).data("category"),t=jQuery(this).data("author"),o=jQuery(this).data("layout"),r=jQuery(this).data("container"),i=jQuery(this).data("exclude-category");$container=jQuery("."+r);var a=$container.find(".each-article").length,n=jQuery("#"+jQuery(this).attr("id"));return n.hasClass("post_loading_loader")||n.hasClass("post_no_more_posts")||jQuery.ajax({type:"POST",dataType:"html",url:window._wp_rp_wp_ajax_url,data:{cat:e,author:t,layout:o,offset:a,exclude:i,action:"luxuo_more_post_ajax"},beforeSend:function(){n.addClass("post_loading_loader").html("Loading...")},success:function(e){var t=jQuery(e);if(t.length){var o=t.css({opacity:0});$container.append(o),o.animate({opacity:1}),n.removeClass("post_loading_loader").html("View More Articles")}else n.removeClass("post_loading_loader").addClass("post_no_more_posts").html("No More Articles");make_edi_pick_fixed()},error:function(e,t,o){n.html(jQuery.parseJSON(e.responseText)+" :: "+t+" :: "+o)}}),!1}jQuery(".gallery").on("initialized.owl.carousel changed.owl.carousel resized.owl.carousel",function(t){e(t)}),jQuery(".view-more-articles").on("click",t),function(){jQuery("#ad-close-btn").on("click",function(){jQuery(".ads-container").hide()})}(),function(){jQuery("ul.menu-bar > li.cat-menu-list > a").on("click",function(e){e.stopPropagation(),"block"==jQuery("#search-container").css("display")&&jQuery("#search-container").hide(),jQuery(this).parents("li").toggleClass("show-sub"),jQuery("ul.menu-bar > li.cat-menu-list > a").not(jQuery(this)).parents("li").removeClass("show-sub")})}(),function(){jQuery("#hompage-owl .item").length>1?jQuery("#hompage-owl").owlCarousel({nav:!0,autoplay:500,pagination:!0,items:1,navSpeed:1e3,fluidSpeed:1e3,smartSpeed:1e3,loop:!0,dots:!0,navText:["<i class='fa fa-angle-left'></i>","<i class='fa fa-angle-right'></i>"]}):jQuery("#hompage-owl").owlCarousel({nav:!1,autoPlay:!1,pagination:!1,items:1,loop:!1,dots:!1})}(),function(){jQuery("#category-owl .item").length>1?jQuery("#category-owl").owlCarousel({nav:!0,autoplay:!0,pagination:!1,items:1,navSpeed:1e3,fluidSpeed:1e3,smartSpeed:1e3,loop:!0,dots:!1,navText:["<i class='fa fa-angle-left'></i>","<i class='fa fa-angle-right'></i>"]}):jQuery("#category-owl").owlCarousel({nav:!1,autoPlay:!1,pagination:!1,items:1,loop:!1,dots:!1})}(),function(){jQuery(".related_post").owlCarousel({nav:!0,pagination:!1,items:3,navSpeed:1e3,fluidSpeed:1e3,smartSpeed:1e3,loop:!0,dots:!0,navText:["<i class='fa fa-angle-left'></i>","<i class='fa fa-angle-right'></i>"]})}(),function(){jQuery(".search-btn,#close-search").on("click",function(e){e.preventDefault(),jQuery("#search-container").toggle("display"),"block"==jQuery("#search-container").css("display")&&jQuery("#search-box").focus(),jQuery(".clear-icon").on("click",function(){jQuery("#search-box").val("")})})}(),function(){jQuery(window).click(function(e){jQuery("ul.menu-bar > li.cat-menu-list").each(function(){jQuery(this).hasClass("show-sub")&&jQuery(this).removeClass("show-sub")}),jQuery(e.target).is("#Layer_1")||"block"==jQuery("#search-container").css("display")&&jQuery("#search-container").hide()}),jQuery(".sub-menu-wrapper").click(function(e){e.stopPropagation()})}(),function(){jQuery("#mobile-menu-btn").click(function(){jQuery(this).toggleClass("open")})}(),function(){jQuery(".search-btn-icon").on("click",function(){jQuery(".search-form-404").submit()})}()}),jQuery(window).load(function(){back_to_top(),handle_article_slider();var e=jQuery("#menu_outer_wrapper"),t=e.offset(),o=t.top;e.data("offset-top",o)}),jQuery(window).scroll(function(){show_back_to_top(),make_edi_pick_fixed_non_infinite(),make_menu_sticky()});
