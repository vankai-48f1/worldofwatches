<?php 
wp_redirect(get_term_link(3), 301);
exit();

get_header(); ?>

<div class='container-fluid mag-page-wrap mag-page-wrap--artrepublik mag-page-wrap--home'>

  <?php get_template_part('templates/artrepublik/header'); ?>

  <?php get_template_part('templates/artrepublik/slider'); ?>
        ...
        <div class="col-md-10 category-container">
          <div class="row">
            ...
            <div class="col-md-8 col-sm-8 left-side">
              ...
              <?php
              $args = array('posts_per_page' => 20, 'tag' => 'artrepublik-news,artrepublik-features');
            ...
            <?php get_template_part('templates/artrepublik/sidebar'); ?>
