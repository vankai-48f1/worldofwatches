<?php
/**
 * Template Name: Category Art Template
 *
 */
...
<section id="primary" class="lx_fixed_sidebar">
    ...
    <div class='container-fluid mag-page-wrap mag-page-wrap--artrepublik mag-page-wrap--home'>
        <?php get_template_part('templates/art-republik-2/header'); ?>
    </div>
          ...
          <div class="col-md-10">
            <div id="owl carousel-owl-container">
              <div id="category-owl" class="owl-carousel">
                <?php
                get_template_part('templates/art-republik-2/featured-slider');          
                ?>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-10 category-container">
            <div class="row">
              ...
              <?php get_template_part('templates/art-republik-2/sidebar'); ?>
            </div>
          </div>
        </div>
      </div>
