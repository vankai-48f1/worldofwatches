  ...
  <div class="col-md-10 col-md-offset-2">
    <div class="row">
      <div class="col-md-10 each-category-section">
        <hr>
        <h3 class="section-title"><?php echo get_cat_name(55156) ?></h3>
        <?php
          $wow_id = 55156; //Properties
          $first_wow_id = '';
        ...
        <div class="row">
          <div class="col-md-8 col-sm-8 left-side" >
            ...
            <div class="category-articles-container">
                <?php
                  $wownetwork_id = 55156; //The Lux List
            ...
            <a class="view-more-articles-home" href="/wow-network">View More Articles</a>
