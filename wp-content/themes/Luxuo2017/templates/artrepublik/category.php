<?php
$page_tag = get_query_var('mag-page-tag', '');
?>

<?php get_header(); ?>

<div class='container-fluid mag-page-wrap mag-page-wrap--artrepublik mag-page-wrap--category'>
        ...
        <div class="col-md-10 category-container">
          <div class="row">
            <div class="col-md-8 col-sm-8 left-side">
              ...
              <?php
              $args = array('posts_per_page' => 20, 'tag' => $page_tag);
