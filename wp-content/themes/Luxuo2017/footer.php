      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-2">
            ...
            <div class="col-md-4 footer-menu">
              <div class="row">
                <?php
                  ...
                  $ceiling = ceil(count($categories)/2);
                  $i = 1;
                ?>
                <div class="col-sm-6 col-xs-6 visible-xs visible-sm">
                  <ul>
                    ...
                    <?php foreach ($categories as $category) { ?>
                      <?php if($i<=$ceiling){ ?>
                        <?php if($category->cat_ID >= $style){?>
                          <li><a href="<?php get_site_url(); ?>/<?php echo $category->slug;?>"><?php echo strtoupper($category->name); ?></a></li>
                        <?php }?>
                      <?php } $i++;
                    }?>
                  </ul>
                ...
                <div class="col-md-6">
                  ...
                  <div class="footer-advertise-with-us">
                    <?php $advertiseMenu = wp_get_nav_menu_items('Advertise',''); ?>
                    <a href="<?php echo $advertiseMenu[0]->url;?>"><?php echo $advertiseMenu[0]->title;?></a>
                  </div>
                </div>
          ...
          <div class="row copyright-container">
            ...
            <div class="col-md-6">
              <div class="copyright">
                Copyright &copy; <?php echo date("Y");?> WOW. All Rights Reserved. Website by <a href="https://leductoan.com">Tony Toàn</a>
              </div>
            </div>
            <?php
            ...
            <div class="col-md-4 terms-container">
              <?php foreach ($tncMenus as $tncMenu) { ?>
              <a href="<?php echo $tncMenu->url?>"> &nbsp; <?php echo $tncMenu->title?> &nbsp; </a>
              <?php
                $i++;
                if($i<=count($tncMenus)){
                  echo '|';
...
<!--end-->
<?php //echo do_shortcode('[view-popup]'); ?>
