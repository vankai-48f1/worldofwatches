        ...
        <div class="row">
          <div class="col-md-8 col-sm-8 left-side"  style="margin-bottom: 40px;">
              <div class="each-category-section">
                <hr>
                <h3 class="section-title"><?php echo get_cat_name(12522) ?></h3>
            </div>
            <div class="category-articles-container">
                <?php
                  $wownetwork_id = 12522; //The Lux List
            ...
            <a class="view-more-articles-home" href="/the-talks">View More Articles</a>
          </div>
